...
class Detector {
    ...
    public:
        ...
        // bool infer_nv21_image_data(const uint8_t* nv21_input, int src_w, int src_h);    
        bool infer_nv21_image_data(image_buffer_t &img_buf);
        std::vector<object_detect_result> object_detect_result_list_;
