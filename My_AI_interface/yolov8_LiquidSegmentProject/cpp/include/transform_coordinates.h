...
// 估计目标物体的实际宽度、高度(过滤掉过小的目标： min_width = 0.2f, min_height = 0.2f)
bool calcObjectSizeByAverage(ObjectCameraDetectResult &one, ObjectSize3D &size_out, float min_width = 0.2f, float min_height = 0.2f);
